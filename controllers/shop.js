  ...
  Product.find()
    ...
    .then((products) => {
      res.render("shop/product-list", {
        ...
        nextPage: page + 1, // page is string and concanated with 1 that is why we use + in req.query.page
        previousPage: page - 1,
  ...
  req.user
    ...
    .then((user) => {
      ...
      const products = user.cart.items.map((i) => {
        return { quantity: i.quantity, product: { ...i.productId._doc } }; // changeable
      });
